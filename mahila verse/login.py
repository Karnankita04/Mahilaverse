...
class Login_window:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file="s3.jpg")
        ...
        self.txtpass=ttk.Entry(frame,font=("arial",11,"bold"))
    ...
    def login(self):
        if self.txtuser.get()=="" or self.txtpass.get()=="":
            ...
            conn = mysql.connector.connect(host="localhost",username="root",password="#prachijindal@7102",database="hotel")
...
class Register:
    def __init__(self,root):
        ...
        ########## LEFT IMAGE #############
        self.bg1=ImageTk.PhotoImage(file="mahila.jpg")
